...
// Define bookmark translations for all remaining languages
const updates = [
  {
    lang: 'zh-CN',
    translations: {
...
updates.forEach(({ lang, translations }) => {
  ...
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      try {
        ...
        console.error(`Failed to parse ${lang}.json, creating new file`);
      }
    }
...
console.log('\n✨ All bookmark translations have been successfully added!');